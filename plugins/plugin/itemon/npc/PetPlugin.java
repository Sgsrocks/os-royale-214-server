...
public class PetPlugin extends PluginContext {
    ...
    protected boolean firstClickNpc(Player player, NpcClickEvent event) {
        ...
        factory.sendNpcChat(7601, Expression.EVIL, "Ehh", "Whatchu need?", "Pet insurance?", "Fo sho man, I gotchu with that insurance.");
    ...
    private void message(DialogueFactory factory) {
        factory.sendNpcChat(7601, Expression.EVIL, "Just use your pet on me and I will insure it", "for " + Utility.formatDigits(Pets.INSRUANCE_COST) + " gold pieces.");
    }

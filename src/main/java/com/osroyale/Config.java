...
public final class Config {
    ...
    public static final String LATEST_ANNOUNCEMENT_THREAD = "https://www.runepk.io/community/index.php?/topic/989-welcome-to-runepk/";

    /** The latest update thread link. */
    public static final String LATEST_UPDATE_THREAD = "https://www.runepk.io/community/index.php?/topic/990-february-24-2018-game-updates/";
    ...
    public static final Position DEFAULT_POSITION = new Position(3086, 3489, 0);
    ...
    public static final Appearance DEFAULT_APPEARANCE = new Appearance(Gender.MALE,
            148, 13, 110, 26, 34, 36, 42, 0, 1, 2, 3, 1);
...
//            "The owner & founder of RunePK is Daniel.",
//            "OS Royale game developers are Daniel and Chex.",
            "Our website is located at: http://runepk.io",
    ...
    static {
        try {
            ...
            GAME_VERSION = parser.getString("client.game_version");

...
public enum AchievementList {
    ...
    /** PvM achievements */
    KILL_10_KBD("Kill King Black Dragons 10 times", 10, KING_BLACK_DRAGON, PVM, 500),
    KILL_100_KBD("Kill King Black Dragons 100 times", 100, KING_BLACK_DRAGON, PVM, 1500),
    KILL_350_KBD("Kill King Black Dragons 350 times", 350, KING_BLACK_DRAGON, PVM, 3000),
    KILL_800_KBD("Kill King Black Dragons 800 times", 800, KING_BLACK_DRAGON, PVM, 5000),
    KILL_10_KRAKENS("Kill Kraken 10 times", 10, KRAKEN, PVM, 500),
    KILL_100_KRAKENS("Kill Kraken 100 times", 100, KRAKEN, PVM, 1500),
    KILL_350_KRAKENS("Kill Kraken 350 times", 350, KRAKEN, PVM, 3000),
    KILL_800_KRAKENS("Kill Kraken 800 times", 800, KRAKEN, PVM, 5000),
    KILL_10_ZULRAH("Kill Zulrah 10 times", 10, ZULRAH, PVM, 500),
    KILL_50_ZULRAH("Kill Zulrah 50 times", 50, ZULRAH, PVM, 1500),
    KILL_300_ZULRAHS("Kill Zulrah 300 times", 300, ZULRAH, PVM, 3000),
    KILL_500_ZULRAHS("Kill Zulrah 500 times", 500, ZULRAH, PVM, 5000),
    KILL_10_COMMANDERS("Kill Commander Zilyana 10 times", 10, ZILYANA, PVM, 500),
    KILL_35_COMMANDERS("Kill Commander Zilyana 35 times", 35, ZILYANA, PVM, 1500),
    KILL_125_COMMANDERS("Kill Commander Zilyana 125 times", 125, ZILYANA, PVM, 3000),
    KILL_500_COMMANDERS("Kill Commander Zilyana 500 times", 500, ZILYANA, PVM, 5000),
    KILL_10_GENERARS("Kill General Graardor 10 times", 10, GRAARDOR, PVM, 500),
    KILL_35_GENERALS("Kill General Graardor 35 times", 35, GRAARDOR, PVM, 1500),
    KILL_125_GENERALS("Kill General Graardor 125 times", 125, GRAARDOR, PVM, 3000),
    KILL_500_GENERALS("Kill General Graardor 500 times", 500, GRAARDOR, PVM, 5000),
    KILL_10_KREES("Kill Kree Arra 10 times", 10, KREE, PVM, 500),
    KILL_35_KREES("Kill Kree Arra 35 times", 35, KREE, PVM, 1500),
    KILL_125_KREES("Kill Kree Arra 125 times", 125, KREE, PVM, 3000),
    KILL_500_KREES("Kill Kree Arra 500 times", 500, KREE, PVM, 5000),
    KILL_10_KRILS("Kill K'ril Tsutaroth 10 times", 10, KRIL, PVM, 500),
    KILL_35_KRILS("Kill K'ril Tsutaroth 35 times", 35, KRIL, PVM, 1500),
    KILL_125_KRILS("Kill K'ril Tsutaroth 125 times", 125, KRIL, PVM, 3000),
    KILL_500_KRILS("Kill K'ril Tsutaroth 500 times", 500, KRIL, PVM, 5000),
    KILL_10_CERBERUS("Kill Cerberus 10 times", 10, CERBERUS, PVM, 500),
    KILL_35_CERBERUS("Kill Cerberus 35 times", 35, CERBERUS, PVM, 1500),
    KILL_125_CERBERUS("Kill Cerberus 125 times", 125, CERBERUS, PVM, 3000),
    KILL_500_CERBERUS("Kill Cerberus 500 times", 500, CERBERUS, PVM, 5000),
    KILL_10_VORKATHS("Kill Vorkath 10 times", 10, VORKATH, PVM, 500),
    KILL_35_VORKATHS("Kill Vorkath 35 times", 35, VORKATH, PVM, 1500),
    KILL_125_VORKATHS("Kill Vorkath 125 times", 125, VORKATH, PVM, 3000),
    KILL_500_VORKATHS("Kill Vorkath 500 times", 500, VORKATH, PVM, 5000),

    /** Skilling achievements */
    MAX_1_SKILL("Achieve level 99 in 1 skill", 1, SKILL_MASTERY, SKILLING, 1500),
    MAX_3_SKILLS("Achieve level 99 in 3 skills", 3, SKILL_MASTERY, SKILLING, 3500),
    MAX_ALL_SKILLS("Achieve level 99 in all skills", Skill.SKILL_COUNT, SKILL_MASTERY, SKILLING, 8000),
    ...
    MAX_200M_EXPERIENCE("Earn 200M EXP in all skills", Skill.SKILL_COUNT, AchievementKey.EXPERIENCE_MASTERY, SKILLING, 15000),
    CAST_100_HIGH_ALCHEMY("Cast high alchemy spell 100 times", 100, HIGH_ALCHEMY, SKILLING, 750),
    CHOP_100_TREES("Chop down 100 trees", 100, WOODCUTTING, SKILLING, 500),
    CHOP_500_TREES("Chop down 500 trees", 500, WOODCUTTING, SKILLING, 1500),
    ...
    MINE_100_ROCKS("Mine 100 rocks", 100, MINNING, SKILLING, 500),
    MINE_500_ROCKS("Mine 500 rocks", 500, MINNING, SKILLING, 1500),
    ...
    RUN_50_COURSES("Complete 50 agility courses", 50, AGILITY, SKILLING, 1000),
    RUN_150_COURSES("Complete 150 agility courses", 150, AGILITY, SKILLING, 1500),
    RUN_500_COURSES("Complete 500 agility courses", 500, AGILITY, SKILLING, 4000),
    RUN_1000_COURSES("Complete 1,000 agility courses", 1000, AGILITY, SKILLING, 7000),
    ...
    MAKE_2500_POTIONS("Make 2,500 potions with herblore", 2500, HERBLORE, SKILLING, 1500),
    MAKE_10000_POTIONS("Make 10,000 potions with herblore", 10000, HERBLORE, SKILLING, 4500),
    ...
    COMPLETE_50_BARROWS("Complete 50 Barrows runs", 25, BARROWS, MINIGAME, 1500),
    COMPLETE_100_BARROW("Complete 100 Barrows runs", 75, BARROWS, MINIGAME, 3500),
    COMPLETE_500_BARROWS("Complete 500 Barrows runs", 250, BARROWS, MINIGAME, 7500),
    ...
    /** Misc achievements */
    COMPLETE_TUTORIAL("Complete the tutorial", 1, AchievementKey.COMPLETE_TUTORIAL, MISCELLANEOUS, 500),
    CHANGE_APPEARANCE("Change your appearance once", 1, AchievementKey.CHANGE_APPEARANCE, MISCELLANEOUS, 500),
    SETUP_PRELOADING_GEAR("Setup your first gear preset", 1, PRELOAD_SETUP, MISCELLANEOUS, 500),
    ...
    ANSWER_10_TRIVIA_BOT("Answer 10 TriviaBot questions", 10, TRIVIABOT, MISCELLANEOUS, 1000),
    ANSWER_30_TRIVIA_BOT("Answer 30 TriviaBot questions", 30, TRIVIABOT, MISCELLANEOUS, 2500),
    ANSWER_100_TRIVIA_BOTS("Answer 100 TriviaBot questions", 100, TRIVIABOT, MISCELLANEOUS, 5000),
    ANSWER_300_TRIVIA_BOT("Answer 300 TriviaBot questions", 3000, TRIVIABOT, MISCELLANEOUS, 7500),
    OPEN_10_CRYSTAL_CHEST("Open 10 crystal chests", 10, CRYSTAL_CHEST, MISCELLANEOUS, 1000),

 ...
 */
public enum PetData {
    BABY_DARTH("Baby Darth", 671, 316) {
        @Override
        public void dialogue(DialogueFactory factory) {
            Player player = factory.getPlayer();
            factory.sendPlayerChat("Wakey wakey baby!");
            factory.sendNpcChat(316, "I'm not a baby!");
            factory.sendOption("What's my PK'ing information?", () -> {
                factory.sendNpcChat(316, "You have " + player.kill + " kills and " + player.death + " deaths.",
                        "Your current killstreak is " + player.killstreak.streak + ".");
            }, "Reset my KDR", () -> {
                factory.sendNpcChat(316, "That will cost you 5,000 blood money.", "Would you like to proceed?");
    ...
    PHOENIX("Phoenix", 20693, 7368) {
        @Override
        public void dialogue(DialogueFactory factory) {
            //TODO http://oldschoolrunescape.wikia.com/wiki/Phoenix
            factory.sendPlayerChat("We have yet to add Phoenix's dialogue :(");
            factory.execute();
        }
    },
    HELLPUPPY("Hellpuppy", 13247, 3099) {
        ...
        public void dialogue(DialogueFactory factory) {
            ...
            factory.sendPlayerChat("We have yet to add Hellpuppy's dialogue :(");
            factory.execute();
        }
    },
...
//            factory.sendPlayerChat("We have yet to add Jal-nib-rek's dialogue :(");
//            factory.execute();
//        }
//    },
    OLMLET("Olmlet", 20851, 7519) {
        ...
        public void dialogue(DialogueFactory factory) {
            ...
            factory.sendPlayerChat("We have yet to add Olmlet's dialogue :(");
            factory.execute();
        }
    },
    SKOTOS("Skotos", 21273, 7671) {
        ...
        public void dialogue(DialogueFactory factory) {
            ...
            factory.sendPlayerChat("We have yet to add Skoto's dialogue :(");
            factory.execute();
        }
    },

...
public class DuelArenaActivity extends Activity {
    ...
    protected void start() {
        ...
        if (rules.contains(DuelRule.OBSTACLES)) {
            player.move(TraversalMap.getRandomTraversableTile(OBSTACLE_ARENAS[0].transform(-12, -7), 6, 15));
            opponent.move(TraversalMap.getRandomTraversableTile(OBSTACLE_ARENAS[0].transform(6, -7), 6, 15));
            ...
            player.move(TraversalMap.getRandomTraversableTile(ARENAS[0].transform(-12, -7), 6, 15));
            opponent.move(TraversalMap.getRandomTraversableTile(ARENAS[0].transform(6, -7), 6, 15));
        }
    ...
    private static class DuelPanel extends Activity_Panel {
        ...
        private String accuracy(Player dueler, Player duelee) {
            ...
            double defenceRoll = rollDefensive(dueler, duelee, type.getFormula());

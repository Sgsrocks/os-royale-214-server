...
public class ClanChannel implements Comparable<ClanChannel> {
    ...
    public void addExperience(double experience) {
        ...
        if (details.level != level) {
            ...
            message(true, "We has leveled up to <col=255>" + Utility.formatEnum(level.name()) + "</col>! Total Experience: <col=255>" + Utility.formatDigits(details.experience), "We have earned <col=255>" + level.getPoints() + "</col> CP, which puts us at <col=255>" + Utility.formatDigits(details.points) + "</col> CP.");
        }
    }

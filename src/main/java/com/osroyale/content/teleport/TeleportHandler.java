        ...
        switch (teleport) {
            case FARMING:
                factory.sendOption("Catherby", () -> {
                    ...
                    player.message("You have teleported to the Catherby farming area.");
                }, "Ardougne", () -> {
                    Teleportation.teleport(player, new Position(2662, 3375, 0));
                    player.message("You have teleported to the Ardougne farming area.");
                }, "Falador", () -> {
                    Teleportation.teleport(player, new Position(3056, 3310, 0));
                    player.message("You have teleported to the Falador farming area.");
                }, "Phasmatys", () -> {
                    Teleportation.teleport(player, new Position(3600, 3524, 0));
                    player.message("You have teleported to the Phasmatys farming area.");
                }).execute();
                break;
            case AGILITY:
            ...
            case RUNECRAFTING:
                factory.sendOption("Abyss", () -> {
                    ...
                    player.send(new SendMessage("You have teleported to the abyss area."));
                }, "Astral Altar", () -> {
                    Teleportation.teleport(player, new Position(2155, 3857, 0));
                    player.send(new SendMessage("You have teleported to the astral altar."));
                }, "Wrath Altar", () -> {
                    Teleportation.teleport(player, new Position(2335, 4826, 0));
                    player.send(new SendMessage("You have teleported to the wrath altar."));
                }, "Ournia Altar", () -> {
                    Teleportation.teleport(player, new Position(2464, 3249, 0));
                    player.send(new SendMessage("You have teleported to the ournia altar."));
                }, "Nevermind", factory::clear).execute();
                break;
            case WOODCUTTING:
...
//                }, "Nevermind", factory::clear).execute();
            ...
            case BARROWS:
                ...
                break;
            case CERBERUS:
                Teleportation.teleport(player, new Position(1240, 1243, 0), 20, () -> CerberusActivity.create(player));
                break;
            case ZULRAH:
                player.locking.lock();

...
public enum Flower implements Plant {
    MARIGOLD(5096, 6010, 2, 20, 0.35, 8.5, 47, 0x08, 0x0c, InspectMessage.MARIGOLD),
    ROSEMARY(5097, 6014, 11, 20, 0.32, 12, 66.5, 0x0d, 0x11, InspectMessage.ROSEMARY),
    NASTURTIUM(5098, 6012, 24, 20, 0.30, 19.5, 111, 0x12, 0x16, InspectMessage.NASTURTIUM),
    WOAD(5099, 1793, 25, 20, 0.27, 20.5, 115.5, 0x17, 0x1b, InspectMessage.WOAD),
    LIMPWURT(5100, 225, 26, 25, 21.5, 8.5, 120, 0x1c, 0x20, InspectMessage.LIMPWURT);
    ...
    Flower(int seedId, int harvestId, int levelRequired, int growthTime, double diseaseChance, double plantingXp, double harvestXp, int startingState, int endingState, InspectMessage inspect) {
        this.seedId = seedId;

...
public class Player extends Mob {
    ...
    public Stopwatch staffOfDeadSpecial = Stopwatch.start().reset(60_000);
    ...
    private void sendInitialPackets() {
        ...
        message("We are currently in early access.");
        ...
        if (players > GameSaver.MAX_PLAYERS) {
            ...
            World.sendMessage("<img=15> <col=2C7526>RPK: </col>We have just broken our maximum players online record! New record: <col=2C7526>" + players + "</col>!");
            Discord.message("We have just broken our maximum players online record! New record: " + players + "!");
        }

...
public enum WeaponInterface {
    ...
    BATTLEAXE(1698, 1701, 7498, 7499, 7511, new FightType[]{
    ...
    SWORD(2276, 2279, 7562, 7574, 7586, new FightType[]{
    ...
    SCIMITAR(2423, 2426, 7587, 7599, 7611, new FightType[]{
    ...
    LONGSWORD(2423, 2426, 7587, 7599, 7611, new FightType[]{
    ...
    MACE(3796, 3799, 7623, 7624, 7636, new FightType[]{
    ...
    KNIFE(4446, 4449, 7637, 7649, 7661, new FightType[]{
            FightType.KNIFE_ACCURATE,
            FightType.KNIFE_RAPID,
            FightType.KNIFE_LONGRANGE
    }),

    SPEAR(4679, 4682, 7662, 7674, 7686, new FightType[]{
    ...
    TWO_HANDED_SWORD(4705, 4708, 7687, 7699, 7711, new FightType[]{
    ...
    PICKAXE(5570, 5573, 7723, 7724, 7736, new FightType[]{
    ...
    CLAWS(7762, 7765, 7788, 7800, 7812, new FightType[]{
    ...
    FLAIL(3796, 3799, 7623, 7624, 7636, new FightType[]{
    ...
    GODSWORD_SWORD(4705, 4708, 7687, 7699, 7711, new FightType[]{
    ...
    SARADOMIN_SWORD(4705, 4708, 7687, 7699, 7711, new FightType[]{
    ...
    BLUDGEN(4705, 4708, 7687, 7699, 7711, new FightType[]{

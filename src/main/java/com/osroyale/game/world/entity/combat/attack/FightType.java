...
public enum FightType {
    ...
    SCIMITAR_CHOP(451, 4, 1, 43, 0, 2429, Equipment.SLASH_OFFENSE, FightStyle.ACCURATE),
    SCIMITAR_SLASH(451, 4, 1, 43, 1, 2432, Equipment.SLASH_OFFENSE, FightStyle.AGGRESSIVE),
    SCIMITAR_LUNGE(412, 4, 1, 43, 2, 2431, Equipment.STAB_OFFENSE, FightStyle.CONTROLLED),
    SCIMITAR_BLOCK(451, 4, 1, 43, 3, 2430, Equipment.SLASH_OFFENSE, FightStyle.DEFENSIVE),

    LONGSWORD_CHOP(451, 5, 1, 43, 0, 2429, Equipment.SLASH_OFFENSE, FightStyle.ACCURATE),
    LONGSWORD_SLASH(451, 5, 1, 43, 1, 2432, Equipment.SLASH_OFFENSE, FightStyle.AGGRESSIVE),
    LONGSWORD_LUNGE(412, 5, 1, 43, 2, 2431, Equipment.STAB_OFFENSE, FightStyle.CONTROLLED),
    LONGSWORD_BLOCK(451, 5, 1, 43, 3, 2430, Equipment.SLASH_OFFENSE, FightStyle.DEFENSIVE),
    ...
    FLAIL_POUND(1658, 5, 1, 43, 0, 3802, Equipment.CRUSH_OFFENSE, FightStyle.ACCURATE),
    FLAIL_PUMMEL(1658, 5, 1, 43, 1, 3805, Equipment.CRUSH_OFFENSE, FightStyle.AGGRESSIVE),
    FLAIL_SPIKE(1658, 5, 1, 43, 2, 3804, Equipment.STAB_OFFENSE, FightStyle.CONTROLLED),
